  ...
  return (
    <article className="rounded-3xl p-6 md:p-7 card-base h-full flex flex-col">
      <div className="flex items-center gap-3 mb-4">
        <div className="w-10 h-10 rounded-full bg-accent-dim border border-accent/30 flex items-center justify-center font-syne font-bold text-accent">
          {testimonio.initial}
        </div>
        <div>
      ...
      <p className="text-accent text-sm mb-3" aria-label={`${testimonio.stars} estrellas`}>
