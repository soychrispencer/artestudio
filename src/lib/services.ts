...
export const SERVICES_DETAILS: ServiceDetail[] = [
  ...
  },
  {
    ...
    shortDescription:
      'Piezas digitales e impresas por tipo (post, carrusel, flyer, presentación). Packs combinables según necesidad.',
    longDescription:
      'Creamos piezas gráficas digitales e impresas para cualquier tipo de negocio: redes, presentaciones, papelería, catálogos y más. Puedes contratar por tipo de pieza, packs combinables o sumar complementos según tu etapa y necesidad.',
    icon: 'Brush',
    color: '#EC4899',
    price: 35000,
    ...
    plans: [
      {
        name: 'Post / Banner digital',
        price: 35000,
        features: [
          '1 pieza estática (post, story o banner)',
          '1 formato final (1:1, 4:5 o 9:16)',
      ...
      {
        name: 'Carrusel / Infografía',
        price: 45000,
        features: [
          'Hasta 6 slides / secciones',
          'Diseño informativo y jerarquía visual',
          '1 formato adicional (1:1 o 9:16)',
          '1 ronda de revisión',
          'Entrega lista para redes',
        ],
      },
      {
      ...
      {
        name: 'Pack Redes 6 piezas',
        price: 150000,
        oldPrice: 180000,
        features: [
          '6 piezas combinables (posts, historias, carruseles)',
      ...
      {
        name: 'Pack Redes 12 piezas',
        price: 260000,
        oldPrice: 320000,
        features: [
          '12 piezas combinables (posts, historias, carruseles)',
          'Hasta 2 formatos por pieza',
          '2 rondas de revisión',
          'Archivos editables incluidos',
          'Optimización para campañas o calendario mensual',
        ],
      },
    ],
    addons: [
      {
        name: 'Papelería básica (tarjeta + firma + hoja)',
        description: 'Pack de identidad para presentación profesional.',
        price: 160000,
      },
      {
